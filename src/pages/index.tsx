  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience a new level of productivity with todo app, your ultimate tool for organizing tasks, projects, and deadlines all in one place."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0b2RvfGVufDB8fHx8MTY5NTgxNTQ3OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience a new level of productivity with todo app, your ultimate tool for organizing tasks, projects, and deadlines all in one place.`}
            </Text>
            <Box
